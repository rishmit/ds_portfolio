...
_Data Science Intern | January 2026 - May 2026_
...
- [Simple RAG Pipele](<./Building a RAG Pipeline>) - This simple RAG pipeline uses local model Ollama and local vector store ChromaDB 
